...
class _KhaltiSDKDemoState extends State<KhaltiSDKDemo> {
  ...
  String pidx =
      'https://khalti.com/pay/pidx123'; // Should be generated via a server-side POST request.
  ...
  void initState() {
    ...
    final payConfig = KhaltiPayConfig(
      publicKey:
          '586447f2352f4f28b07d1030f79e55c0', // This is a dummy public key for example purpose
      pidx: pidx,
